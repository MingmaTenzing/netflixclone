    ...
    <main className="flex items-center justify-between  lg:p-4">
      <div>
        <Image
          ...
          width={200}
          height={200}
          className="w-20 sm:w-[120px] lg:w-[150px]"
          alt="Netflix Logo"
        />
      </div>
        ...
        {user ? (
          <div className="relative text-white flex flex-col items-center">
            <Image
              ...
              height={200}
              alt="profile icon"
              className="w-8 md:w-[60px] rounded-lg"
            />
            {openModal && (
              <div className="bg-[#141414] border border-gray-500 p-2 rounded-xl shadow-lg text-[12px] space-y-2 absolute top-8 md:top-16 -left-20 md:-left-12 flex flex-col items-center text-center ">
          ...
          <>
            ...
            <button
              ...
              className=" py-1 px-2 lg:px-3 rounded-lg bg-NetflixRed  text-white text-sm  sm:text-base md:text-lg"
            >
              {" "}
              Sign in
            </button>
